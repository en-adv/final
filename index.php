        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <li><a class="dropdown-item" href="category/sejarah.php">Sejarah</a></li>
                <li><a class="dropdown-item" href="category/komputer.php">Ilmu Komputer</a></li>
                <li><a class="dropdown-item" href="category/karyasastra.php">Karya Sastra</a></li>
              </ul>
            </li>
          </ul>
        </div>
